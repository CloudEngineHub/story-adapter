import torch
from diffusers import StableDiffusionXLPipeline, StableDiffusionXLControlNetPipeline, StableDiffusionImg2ImgPipeline, StableDiffusionInpaintPipelineLegacy, DDIMScheduler, AutoencoderKL, ControlNetModel
from PIL import Image
import numpy as np
from ip_adapter import StoryIterXLControlnet
import os
import random
import argparse
...
story7=[
'a man in a black jacket, opened eyes.',
'a man in a black jacket, stretched its arms.',
'a man in a black jacket, shook the snow.',
'a man in a black jacket, looks to the village in the distance in the snow.',
'a man in a black jacket, walking in forest in the snow.',
'a man in a black jacket, find a bird in forest in the snow.',
"a man in a black jacket, talking bird in snow forest.",
"a man in a black jacket, walking in snow forest path.",
"a man in a black jacket, met a child in village in snow.",
"a man in a black jacket, playing with children in village in snow.",
"a man in a black jacket, made a little snowman.",
"a man in a black jacket, touching scarf on little snowman.",
"a man in a black jacket, give carrot to little snowman.",
'a man in a black jacket, and children dancing together.',
'a man in a black jacket, and children singing together.',
'a man in a black jacket, on the ice.',
'a man in a black jacket, did some graceful skating movements.',
'a man in a black jacket, fell on the snow ground.',
'a man in a black jacket, stood up and continued skating.',
'a man in a black jacket, saw a fox in snow.',
'a man in a black jacket, greeted the fox.',
'a man in a black jacket, and fox run together in the snow.',
'a man in a black jacket, chased the fox.',
'a man in a black jacket, rolled a big ball of snow.',
'a man in a black jacket, sat in the snow to rest.',
'a man in a black jacket, watched the snowflakes fall in the sky.',
'a man in a black jacket, reached out to catch a snowflake.',
'a man in a black jacket, felt the warm sunshine.',
'a man in a black jacket, look the village bell.',
'a man in a black jacket, walked into the village.',
'a man in a black jacket, buy shoe in village store.',
'a man in a black jacket, buy gifts in village market.',
'a man in a black jacket, build the Christmas tree.',
'a man in a black jacket, lit the lights on the Christmas tree.',
'a man in a black jacket, decorate the Christmas tree.',
'a man in a black jacket, giving stars and bells to Christmas tree.',
'a man in a black jacket, eating a sweet cookie.',
'a man in a black jacket, give a gift box to children in village.',
'children hugs a man in a black jacket, in village.',
'a man in a black jacket, holding a gift box in village.',
'a man in a black jacket, looks fireworks blooming in the distance.',
'a man in a black jacket, and children watch fireworks together.',
'a man in a black jacket, build a ice house.',
'a man in a black jacket, sleeping in ice.'
]
...
parser.add_argument('--story', default=story7, nargs='+', type=str)
...
for i, (text, op) in enumerate(zip(prompts,openpose_files)):
    print(op)
    op_map = Image.open(os.path.join(openpose_root,op)).resize((1024, 1024))
    images = storyiter.generate(pil_image=None, image=op_map, num_inference_steps=50, num_samples=1, seed=seed,
...
for i, scale in enumerate(scales):
    ...
    print(f'epoch:{i+1}')
    for y, (text, op) in enumerate(zip(prompts,openpose_files)):
        print(op)
        op_map = Image.open(os.path.join(openpose_root,op)).resize((1024, 1024))
        image = storyiter.generate(pil_image=images, image=op_map, num_inference_steps=50, num_samples=1, seed=seed,
